...
constexpr auto qt_meta_stringdata_CLASSNotesManagerENDCLASS = QtMocHelpers::stringData(
    "NotesManager",
    "newNoteCreated",
    "",
    "id",
...
Q_CONSTINIT const QMetaObject NotesManager::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSNotesManagerENDCLASS_t,
        ...
        // method 'newNoteCreated'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        // method 'noteContentChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>
    >,
    nullptr
...
void NotesManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->newNoteCreated((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->noteContentChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &NotesManager::newNoteCreated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (NotesManager::*)(int );
            if (_t _q_method = &NotesManager::noteContentChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void NotesManager::newNoteCreated(int _t1)
{
...
// SIGNAL 1
void NotesManager::noteContentChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
